...
public static class ResponseCleaner
{
    ...
    private static readonly Regex InternalLineRegex = new(
        @"^\s*(?:(?:CHOICE_A|CHOICE_B|STORY_MEMORY|FORMAT REMINDER|RIDDLE_ANSWER|RIDDLE_CATEGORY|RIDDLE_DIFFICULTY|RIDDLE_TURN_KIND|GAME_TYPE|GAME_DIFFICULTY|GAME_TURN_KIND):.*|-{3,}\s*)$",
