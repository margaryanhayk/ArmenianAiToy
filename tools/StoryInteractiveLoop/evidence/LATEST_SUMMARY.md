...
| Avg Choice quality | 76.0 |
| Avg Continuation | 88.0 |
...
| `choice_repeated_from_earlier_turn` | 3 |
...
- session 1: `story-loop-20260524-200655-01.md` / `story-loop-20260524-200655-01.json`
- session 2: `story-loop-20260524-200655-02.md` / `story-loop-20260524-200655-02.json`
- session 3: `story-loop-20260524-200655-03.md` / `story-loop-20260524-200655-03.json`
- session 4: `story-loop-20260524-200655-04.md` / `story-loop-20260524-200655-04.json`
- session 5: `story-loop-20260524-200655-05.md` / `story-loop-20260524-200655-05.json`
