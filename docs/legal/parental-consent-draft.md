...
**Armenian draft (for armenian-linguistic-reviewer sign-off before publishing):**
...
> սեփական մուտքագրումը։ Գրանցվելով՝ **դուք** հաստատում եք, որ այդ երեխայի
> ծնողն կամ խնամակալն եք, և հենց դուք եք տալիս ստորև նկարագրված
> համաձայնությունը։
>
> **Ինչ ենք հավաքում Ձեր երեխայի մասին.** Ձեր նշած անունը, ծննդյան տարեթիվը
> և սեռը (օգտագործվում է միայն հայերենը ճիշտ խոսելու և բովանդակությունը
> տարիքին համապատասխանեցնելու համար)․ Ձեր երեխայի ասածի ձայնագրությունը և
> տեքստը, ինչպես նաև Areg-ի պատասխանի տեքստը․ արդյոք ավտոմատ անվտանգության
> ստուգումը ինչ-որ բան նշել է որպես խնդրահարույց․ որ հեքիաթներն ու
> խաղերն են խաղացվել և երբ։
>
> **Ինչու.** որպեսզի Areg-ը կարողանա պատասխանել Ձեր երեխային իր լեզվով,
> խոսակցությունը մնա տարիքին համապատասխան և անվտանգ, և Դուք կարողանաք
> տեսնել ամեն ինչ Ձեր վահանակում։
>
> **Ինչ չենք անում.** մենք չենք ցուցադրում գովազդ Ձեր երեխային, չենք կազմում
> Ձեր երեխայի գովազդային պրոֆիլ, և չենք վաճառում Ձեր երեխայի տվյալները
> ոչ մեկին, ոչ մի պատճառով։
>
> **Որքան ժամանակ ենք պահում.** Ձեր երեխայի ասածը և դրա ձայնագրությունը
> ինքնաբերաբար ջնջվում են խոսակցությունից 90 օր հետո, լռելյայն։
> [ՏԵՂԱԴԻՐ — սպասվում է վերևի 7/8 բացերի փակմանը]
>
> **Համաձայնությունը հետ վերցնելը.** Դուք կարող եք ցանկացած պահի ջնջել Ձեր
> երեխայի պրոֆիլը, մեկ խոսակցություն, անջատել խաղալիքը կամ ջնջել ամբողջ
> հաշիվը ծնողական վահանակից։ Հաշիվը ջնջելը այն և դրա տվյալները անմիջապես
> հեռացնում է մեր աշխատող համակարգերից. պահուստային պատճենում այն կարող է
> մնալ մոտավորապես մեկ շաբաթ, մինչև հերթական պահուստը փոխարինի այն։
...
**Armenian draft (for armenian-linguistic-reviewer sign-off):**

> **Իրավական հիմք.** Մենք մշակում ենք Ձեր երեխայի տվյալները՝ հիմնվելով Ձեր՝
> որպես ծնողի կամ խնամակալի համաձայնության վրա, ինչպես նաև Ձեզ հետ կնքված
> պայմանագիրը (Ձեր գրանցված ծառայությունը մատուցելը) կատարելու հիմքով։
>
> **Երեխաների տվյալները.** Areg-ը ստեղծված է երեխաների համար, ովքեր, մեծ
> մասամբ կիրառելի իրավական շրջանակներով, դեռ չեն հասել այն տարիքին, երբ
> երեխան կարող է ինքնուրույն համաձայնություն տալ։ Մենք հենվում ենք Ձեր՝
> որպես ծնողի/խնամակալի համաձայնության վրա, ոչ թե երեխայի։
>
> **Որտեղ են մշակվում տվյալները.** Մեր սերվերները և ստորև նշված
> մշակողները գտնվում են ԱՄՆ-ում։ [ՏԵՂԱԴԻՐ — իրավաբանը պետք է հաստատի
...
>   գործել։
> - Resend (ԱՄՆ) — Ձեզ մեր տրանզակցիոն նամակների առաքում։
...
`LoginScreen.tsx` directly, not inferred.

**What was NOT done, and must happen before any of this reaches a parent:**
no lawyer has read any word of this file; no Armenian text here has yet
been reviewed by the armenian-linguistic-reviewer agent (this session's
own tooling) — that review is the very next step, not skipped, and this
file should be treated as pre-review until that pass lands; the Russian
